...
const SocialPriceChart = (props: any) => {
    ...
    return (
        <Box
            ...
            <Typography variant="h6" sx={{ p: 2 }}>TerraUSD (UST)</Typography>
            <Box
                sx={(theme) => ({
                    width: '1',
                    mt: 2,
                ...
                <ResponsiveContainer width="100%" height={500}>
                    ...
                    >
                        <XAxis
                            ...
                            height={55}
                            tickFormatter={(value) => {
                                let newVal = moment(value).format('HH:00')
                                if (newVal === 'Invalid date') return value;
                                else return newVal;
                            }}
                        ...
                        {/* <ReferenceLine x="07/05 00:00" opacity={0.8} stroke="white" strokeDasharray="3 3" strokeWidth={2}>
                            <Label position='insideTopLeft' fill='white' opacity={0.8}>07/05</Label>
                        </ReferenceLine>
                        ...
                        <ReferenceLine x="12/05 00:00" opacity={0.8} stroke="white" strokeDasharray="3 3" strokeWidth={2}>
                            <Label position='insideTopLeft' fill='white' opacity={0.8}>12/05</Label>
                        </ReferenceLine> */}
                    </LineChart>
                </ResponsiveContainer>
            </Box>
